...
def getInfo(id):
    url = 'https://prod-chn-gcp-common-api.workjam.com/api/v4/companies/1549136564541/locations/1560474627780369/shifts/' +str(id)
...
if __name__ == '__main__':
    df = pd.read_excel('URL.xlsx', sheet_name='Sheet2')
