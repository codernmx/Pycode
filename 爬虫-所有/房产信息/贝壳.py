...
def getDetail(singurl):
    ...
    # title = sou.select(".detailHeader.VIEWDATA > .title-wrapper > .content > .title > h1")[0].string
...
for j in range(3, 350):
    print('当前获取页码------------',j)
    url = 'https://bj.ke.com/ershoufang/pg' + str(j) + '/'
    ...
    for i in allUrl:
        ...
        # [huxing, louceng, mianji, zhuangxiuqingkuang, jiage, xiaoqu, quyu, fangwuchaoxiang, peibeidianti, guapaishijianStr,fangwuyongtu]
